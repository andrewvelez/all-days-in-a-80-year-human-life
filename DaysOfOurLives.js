...
var DaysOfOurLives = (function () {
  ...
  let parseBirthday = function () {
    let dateString = (getUrlVars()['birthday'] || '1970-01-01')
  ...
  let createLifeYearHtml = function (fullYear, birthday, deathday) {
    ...
    for (let currentDay = new Date(fullYear, 0, 1); currentDay.getFullYear() === fullYear; currentDay = addDay(currentDay)) {
  ...
  let createLifeAllDaysHtml = function () {
    ...
    for (let currentYear = birthday.getFullYear(); currentYear <= deathday.getFullYear(); ++currentYear) {
